# web_data_app.py
# June 2024
# Modified by: Jaskirat Singh (Jazz)
#
...
def book_data():
    ...
    titles = []
    prices = []
    # Reduced prices are 25% off the original price
    reduced_prices = []
    ...
    for book in book_results:
        ...
        # 25% discount on all books
        reduced_prices.append(prices[-1] * 0.75)  

    # Create a DataFrame using the two lists
    book_data = pd.DataFrame(list(zip(titles, prices, reduced_prices)), columns=['Titles','Prices', 'Reduced Prices'])    
...
def learn():
    ...
    return "I learned about multi-index dataframes. They are like a supercharged multi-dimentional array. Having multiple levels of indexing is a game changer for data analysis by code."
